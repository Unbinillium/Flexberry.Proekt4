...
(
	...
	"ЭкоКласс" RAW(16) NOT NULL,

	"ЗащСвойства" RAW(16) NOT NULL,
...
ALTER TABLE "Номенклатура"
	ADD CONSTRAINT "Номенклатура__1323" FOREIGN KEY ("ЭкоКласс") REFERENCES "ЭкоКласс" ("primaryKey");

CREATE INDEX "Номенклатура__7825" on "Номенклатура" ("ЭкоКласс");

ALTER TABLE "Номенклатура"
	ADD CONSTRAINT "Номенклатура__2295" FOREIGN KEY ("ЗащСвойства") REFERENCES "ЗащСвойства" ("primaryKey");

CREATE INDEX "Номенклатура__7722" on "Номенклатура" ("ЗащСвойства");

ALTER TABLE "ГотПродукция"
	ADD CONSTRAINT "ГотПродукция__5708" FOREIGN KEY ("Перемещение") REFERENCES "Перемещение" ("primaryKey");

CREATE INDEX "ГотПродукция__7262" on "ГотПродукция" ("Перемещение");
...
ALTER TABLE "Сотрудники"
	ADD CONSTRAINT "Сотрудники_FП_7101" FOREIGN KEY ("Подразделение") REFERENCES "Подразделение" ("primaryKey");

CREATE INDEX "Сотрудники_IП_8073" on "Сотрудники" ("Подразделение");
